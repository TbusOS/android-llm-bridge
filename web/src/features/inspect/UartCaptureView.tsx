/**
 * UART captures view (PR-C.a) — REST capture-style.
 *
 * Stateless viewer:
 ...
 *
 * Pairs with <UartLiveStream> (PR-C.b, WS + xterm.js) — both rendered
 * inside <UartTab> via a Capture/Live segment toggle.
 */
...
export function UartCaptureView() {
